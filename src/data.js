export const featuredPortfolio = [
  ...
  //   id: 3,
  //   title: "Pagado-bar",
  //   img: "/assets/Pagado-bar-screenshot.png"
  // },
  {
    id: 4,
  ...
  export const otherPortfolio = [
    {
      id: 1,
      title: "Head Count",
      tooltip:"computer vision application to count number of passing a field of view in mp4 file",
      img: "assets/head-count.png",
    },
    {
      id: 2,
      title: "Python Printer Connect",
      tooltip: "python script for interface between web application and POS thermal printer",
      img: "assets/escpos_python.jpeg",
    },
  ...
  export const skill_set_data = [
    ...
    },
    {
      ...
      name: "PHP",
      title: "Php",
      list:"POST, explode, implode, CORS policy workarounds\n\n",
